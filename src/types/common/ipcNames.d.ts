type NameMapAssert = LxMusic.Common.ModuleNameMap<string>;
...
export type IpcNameMap<T extends NameMapAssert = NameMap> = {
  [module in keyof T]: {
    [type in keyof T[module]]: `${module}_${T[module][type]}`;
  };
}
