...
export default {
  ...
  computed: {
    ...
    /** @returns { { isExist: boolean; id: string; name: string; list: LxMusic.UserApiEvent.SongInfo[]; location: number; source: LxMusic.Renderer.MusicSourcesId; sourceListId: string; }[]; } */
    lists() {
